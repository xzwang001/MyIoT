...
void joylink_printf_info(uint8_t*pStr, uint16_t ret);


extern JLDevice_t  *_g_pdev;

extern uint8_t g_recBuffer[JL_MAX_PACKET_LEN * 2];
extern uint8_t g_recPainText[JL_MAX_PACKET_LEN * 2 + 16];
