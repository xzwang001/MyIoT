...
*/
void uECC_set_rng_joylink(uECC_RNG_Function rng_function);
...
*/
int uECC_make_key_joylink(uint8_t public_key[uECC_BYTES*2], uint8_t private_key[uECC_BYTES]);
...
*/
int uECC_shared_secret_joylink(const uint8_t public_key[uECC_BYTES*2],
...
*/
int uECC_sign_joylink(const uint8_t private_key[uECC_BYTES],
...
Returns 1 if the signature generated successfully, 0 if an error occurred.
*/
int uECC_sign_deterministic_joylink(const uint8_t private_key[uECC_BYTES],
                            const uint8_t message_hash[uECC_BYTES],
...
*/
int uECC_verify_joylink(const uint8_t private_key[uECC_BYTES*2],
...
*/
void uECC_compress_joylink(const uint8_t public_key[uECC_BYTES*2], uint8_t compressed[uECC_BYTES+1]);
...
*/
void uECC_decompress_joylink(const uint8_t compressed[uECC_BYTES+1], uint8_t public_key[uECC_BYTES*2]);
...
*/
int uECC_valid_public_key_joylink(const uint8_t public_key[uECC_BYTES*2]);
...
*/
int uECC_compute_public_key_joylink(const uint8_t private_key[uECC_BYTES],
